  ...
  return (
    <div className='h-[100vh] w-[100vw] flex justify-center items-center bg-gray-300'>
      <div className='h-96 w-96 flex flex-col rounded-lg justify-center items-center bg-red-200' style={{backgroundColor:"#133E87"}}>
        <input type='text' value={emailId} onChange={e=>{setEmailId(e.target.value)}} placeholder='Enter Name' className='h-10 w-60 rounded-md border-2 border-gray-400 p-2 mb-6 text-black placeholder-black'  style={{backgroundColor:"#608BC1"}}/>
